                                ...
                                <tbody>
                                    {users.slice(0, 8).map(u => (
                                        <tr key={u._id} className="border-b border-slate-50 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                            <td className="py-3 px-3 font-medium text-slate-700 dark:text-slate-200">{u.name}</td>
                                            ...
                                            <td className="py-3 px-3 text-slate-400 dark:text-slate-500">{u.department || '—'}</td>
